...
from apps.processos.views.processos.edicao import EdiProcessos
from apps.processos.views.processos.delecao import DelProcessos
from apps.processos.views.processos.andamentos import ListAndamentos, AtualizarAndamentos
...
urlpatterns = [
    path('listagem_andamentos', ListAndamentos.as_view(), name='listagem_andamentos'),
    path('listagem_andamentos/<int:processo_id>', ListAndamentos.as_view(), name='listagem_andamentos'),

    path('atualizar_andamentos', AtualizarAndamentos.as_view(), name='atualizar_andamentos'),
    path('atualizar_andamentos/<int:processo_id>', AtualizarAndamentos.as_view(), name='atualizar_andamentos'),
    ...
    path('edicao_processos', EdiProcessos.as_view(), name='edicao_processos'),
    path('edicao_processos/<int:pk>', EdiProcessos.as_view(), name='edicao_processos'),
    path('autocomplete_processos', AutoCompProcessos.as_view(), name='autocomplete_processos'),

    path('delecao_processos', DelProcessos.as_view(), name='delecao_processos'),
    path('delecao_processos/<int:pk>', DelProcessos.as_view(), name='delecao_processos'),
