...
class Calculos(models.Model):
    ...
    class Meta:
        ...
        permissions = [
            ('view_meus_calculos', 'Can view Meus Cálculos'),
            ('add_meus_calculos', 'Can add Meus Cálculos'),
            ('change_meus_calculos', 'Can change Meus Cálculos'),
            ('delete_meus_calculos', 'Can delete Meus Cálculos'),
            ('importar_calculos', 'Can import Cálculos'),
        ]
