...
from apps.clientes.views.tipo_servicos.listagem import ListResponsaveisTipoServicosJson, \
    ListTipoServicosCliente, ListTipoServicosClienteJson
...
urlpatterns = [
    ...
    path('listagem_responsaveis_tipo_servicos_select', ListResponsaveisTipoServicosJson.as_view(), name='listagem_responsaveis_tipo_servicos_select'),
    path('listagem_responsaveis_tipo_servicos_select/<int:tipo_servico_id>', ListResponsaveisTipoServicosJson.as_view(), name='listagem_responsaveis_tipo_servicos_select'),
