    ...
    def process_request(self, request):
        ...
        setattr(request,
            ...
            [
                ...
                {
                    'title': 'Calculos',
                    'permission': request.user.has_perm('calculos.view_calculos') or request.user.has_perm('calculos.view_meus_calculos'),
                    'icon': 'mdi mdi-calculator',
                    'color': '#ffb848',
                    'url': '',
                    'url_home': reverse('listagem_calculos_processo'),
                    'submenu':[
                        {
                            'title': 'Todos os Cálculos',
                        ...
                        },
                        {
                            ...
                            'permission': request.user.has_perm('calculos.importar_calculos'),
