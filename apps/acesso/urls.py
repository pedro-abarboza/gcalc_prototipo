...
from apps.acesso.views.usuarios.perm_servicos import PermServicos
...
urlpatterns = [
    ...
    path('perm_servicos', PermServicos.as_view(), name='perm_servicos'),
    path('perm_servicos/<int:pk>', PermServicos.as_view(), name='perm_servicos'),
